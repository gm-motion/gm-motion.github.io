...
import {FooterSocial} from './core/sanity/schemas/headerFooter';
...
export class AppComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  @ViewChild('darkModeSwitch', {read: ElementRef}) darkModeSwitch!: ElementRef;
  ...
  async ngOnInit(): Promise<void> {
    ...
    try {
      const headerFooterData = await this.sanityContentService.getHeaderFooter()
  ...
  ngAfterViewInit() {
    ...
    this.headerElements.forEach(
        (el) => this.headerObserver.observe(el.nativeElement),
    );
